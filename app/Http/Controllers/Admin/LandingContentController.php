...
class LandingContentController extends Controller
{
    public function categories(): JsonResponse
    {
        return response()->json([
            'data' => ExperienceCategory::query()->sorted()->paginate(20),
        ]);
    }
    ...
    {
        return response()->json([
            'data' => Destination::query()->sorted()->paginate(20),
        ]);
    }
    ...
    {
        return response()->json([
            'data' => Landmark::query()->sorted()->paginate(20),
        ]);
    }
    ...
    {
        return response()->json([
            'data' => LandingFaq::query()->sorted()->paginate(20),
        ]);
    }
    ...
    public function reels(): JsonResponse
    {
        return response()->json([
            'data' => TravelReel::query()->sorted()->paginate(20),
        ]);
    }
    ...
    {
        return response()->json([
            'data' => Testimonial::query()->sorted()->paginate(20),
        ]);
    }
