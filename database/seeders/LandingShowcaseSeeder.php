...
class LandingShowcaseSeeder extends Seeder
{
    ...
    private function experiences(Agency $agency): void
    {
        $items = [
            [
                ...
                'title' => ['en' => 'Showcase Marrakech balloon ride', 'fr' => 'Vol en montgolfière showcase à Marrakech', 'nl' => 'Showcase Marrakech balloon ride'],
                'description' => [
                    ...
                    'nl' => 'Sample detail-page listing for local UI review. It uses demo copy and public imagery so the gallery, booking card, trust blocks, and trip information can be reviewed before verified supplier content is available.',
                ],
                'category' => 'adventure',
                ...
                'inclusions' => [
                    ...
                    'nl' => ['Demo hotel pickup coordination', 'Sample Moroccan breakfast line', 'Sample flight certificate', 'Shared transport for local preview'],
                ],
                'exclusions' => [
                    ...
                    'nl' => ['Personal expenses', 'Tips', 'Anything not listed in inclusions'],
                ],
                'media' => [
            ...
            [
                ...
                'title' => ['en' => 'Marrakesh food walk', 'fr' => 'Balade gourmande à Marrakech', 'nl' => 'Marrakesh food walk'],
                'description' => ['en' => 'A sample marketplace listing for browsing food experiences in Marrakesh.', 'fr' => 'Une fiche exemple pour parcourir les expériences culinaires à Marrakech.', 'nl' => 'A sample marketplace listing for browsing food experiences in Marrakesh.'],
                'category' => 'food',
                'location_city' => 'Marrakesh',
                'duration_hours' => '3.0',
            ...
            [
                ...
                'title' => ['en' => 'Sahara desert camp', 'fr' => 'Camp dans le désert du Sahara', 'nl' => 'Sahara desert camp'],
                'description' => ['en' => 'A sample marketplace listing for browsing desert experiences.', 'fr' => 'Une fiche exemple pour parcourir les expériences dans le désert.', 'nl' => 'A sample marketplace listing for browsing desert experiences.'],
                'category' => 'desert',
            ...
            [
                ...
                'title' => ['en' => 'Fes craft workshop', 'fr' => 'Atelier artisanal à Fès', 'nl' => 'Fes craft workshop'],
                'description' => ['en' => 'A sample marketplace listing for browsing craft workshops in Fes.', 'fr' => 'Une fiche exemple pour parcourir les ateliers artisanaux à Fès.', 'nl' => 'A sample marketplace listing for browsing craft workshops in Fes.'],
                'category' => 'workshop',
                'location_city' => 'Fes',
                'duration_hours' => '2.5',
            ...
            [
                ...
                'title' => ['en' => 'Chefchaouen photo walk', 'fr' => 'Balade photo à Chefchaouen', 'nl' => 'Chefchaouen photo walk'],
                'description' => ['en' => 'A sample marketplace listing for browsing photography walks in Chefchaouen.', 'fr' => 'Une fiche exemple pour parcourir les balades photo à Chefchaouen.', 'nl' => 'A sample marketplace listing for browsing photography walks in Chefchaouen.'],
            ...
            [
                ...
                'title' => ['en' => 'Essaouira coast day', 'fr' => 'Journée côte à Essaouira', 'nl' => 'Essaouira coast day'],
                'description' => ['en' => 'A sample marketplace listing for browsing coastal experiences in Essaouira.', 'fr' => 'Une fiche exemple pour parcourir les expériences côtières à Essaouira.', 'nl' => 'A sample marketplace listing for browsing coastal experiences in Essaouira.'],
                'category' => 'water',
            ...
            [
                ...
                'title' => ['en' => 'Atlas mountain hike', 'fr' => 'Randonnée dans l’Atlas', 'nl' => 'Atlas mountain hike'],
                'description' => ['en' => 'A sample marketplace listing for browsing mountain experiences.', 'fr' => 'Une fiche exemple pour parcourir les expériences en montagne.', 'nl' => 'A sample marketplace listing for browsing mountain experiences.'],
                'category' => 'mountain',
                'location_city' => 'Marrakesh',
                'duration_hours' => '6.0',
    ...
    private function testimonials(): void
    {
        $items = [
            [
                'author_name' => ['en' => 'Demo traveler', 'fr' => 'Voyageur démo', 'nl' => 'Demo traveler'],
                ...
                'body' => [
                    ...
                    'nl' => 'Sample story content for local development. Replace it with verified traveler feedback before production.',
                ],
            ...
            [
                'author_name' => ['en' => 'Sample guest', 'fr' => 'Invité exemple', 'nl' => 'Sample guest'],
                'author_country' => 'Sample content',
                'body' => [
                    ...
                    'nl' => 'Use this card to review spacing, typography, and the testimonial layout while real reviews are not available yet.',
                ],
                'experience_title' => 'Development seed',
                'rating' => '5.00',
                'sort_order' => 1,
